...
var uid=*heartAuth.currentUser.uid, h={};
snap.forEach(function(doc){ var d=doc.data(); if(d.likedBy&&d.likedBy.includes(uid)) h[doc.id.replace(/*/g,’#’)]=true; });
...
var ref=*heartDB.collection(‘photo_likes’).doc(code.replace(/#/g,’*’));
