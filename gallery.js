...
/* CSS 변수 */
  ...
  *:focus-visible{ outline:2px solid rgba(212,175,55,0.8); outline-offset:3px; }
  ...
  .moon-glow1{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:140px;height:140px;border-radius:999px;background:radial-gradient(circle,rgba(220,210,170,0.22) 0%,rgba(200,190,150,0.08) 55%,transparent 100%);animation:moonGlow1 6.4s ease-in-out infinite;z-index:2;}
  .moon-glow2{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:240px;height:240px;border-radius:999px;background:radial-gradient(circle,rgba(200,190,150,0.10) 0%,rgba(180,170,130,0.04) 55%,transparent 100%);animation:moonGlow2 6.4s ease-in-out infinite;z-index:1;}
  .moon-ring{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:100px;height:100px;border-radius:999px;border:0.5px solid rgba(220,210,170,0.25);animation:moonRing 6s ease-out infinite;z-index:2;}
  ...
  .rst-wl{position:absolute;left:0;width:100%;height:500px;transform-origin:bottom center;overflow:visible;will-change:transform;backface-visibility:hidden;opacity:0.75;}
...
if (isMobile) {
  ...
  if (SC.type === "rest") {
    ...
    // 크기 절반(120px), 위치: photoArea 정중앙
    mIconWrap.style.cssText = "position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:480px;height:480px;display:grid;place-items:center;cursor:pointer;z-index:5;";
